...
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a><span>/</span><a href="paint" class="on">墙式壁挂</a>
    </div>
</div><!-----------------paintCon------------------------------->
<div class="paintCon">
    <section class="wrapper"><h3><img src="img/temp/tit01.jpg"></h3><img src="img/temp/paint01.jpg"/>
        <div class="paintList"><a href="proDetail">
            <dl>
    ...
    <section class="wrapper"><h3><img src="img/temp/tit03.jpg"></h3>
        <div class="paintList third"><p><a href="proDetail"><img src="img/temp/sec301.jpg"/></a></p>
            <div class="sec"><a href="proDetail">
                <dl>
    ...
    <section class="wrapper"><h3><img src="img/temp/tit03.jpg"></h3>
        <div class="paintList last"><p><a href="proDetail"><img src="img/temp/sec401.jpg"/></a><a
                href="proDetail"><img src="img/temp/sec402.jpg"/></a></p>
            <div class="sec"><a href="proDetail">
                <dl>

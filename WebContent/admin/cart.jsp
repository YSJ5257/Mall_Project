    ...
    <div class="table wrapper">
        ...
        <c:forEach items="${cartGoodsList }" var="item">
        	<div id="th" class="th">
            	...
            	<a class="fl"  href="#">
                	<dl class="clearfix">
                   	 <dt class="fl"><img src="${item.specification_photo }"></dt>
                   	 <dd class="fl"><p>${item.goods_describe }</p>
                        <p>颜色分类:</p>
                        <p>${item.specification_name }</p></dd>
                	</dl>
            	</a>
            </div>
...
<div class="mask"></div>
	...
	<p>确定要删除该商品吗？</p>
    <p class="clearfix">
    	<a class="fl cer" href="javascript:void(0)" @click="delGudeg" >确定</a>
...
<script type="text/javascript">
	const app=new Vue({
		...
		methods:{
			getShoppingTrolleyId:function(id){
				this.shoppingTrolleyId=id;
			},
			delGudeg:function(){
				axios.get("cartAjax",{
					params:{
						id:this.shoppingTrolleyId
					}
				}).then((ret)=>{});
			},
			clearing:function(){
